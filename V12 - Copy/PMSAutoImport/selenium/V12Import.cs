...
namespace PMSAutoImport
{
    public abstract class V12Import
    {
        ...
        private string ownerCoid = "0";
        private string formCoid = "0";

        public void setOwnerCoid(string ownerCoid)
        {
            this.ownerCoid = ownerCoid;
        }

        public void setFormCoid(string formCoid)
        {
            this.formCoid = formCoid;
        }
        ...
        public V12Import(string companyId, string account, string password, string productCode)
        {
            ...
            importFolder = "z:\\" + companyId + "\\";  //ConfigurationManager.AppSettings[companyId + "importFolder"];
        ...
        public virtual void login()
        {
            ...
            string login = account.Split(',')[1];//"EZinspections";//importInfo.ClientSiteLogin.Split('-')[1];
            //string password = password;//importInfo.ClientSitePassword.Replace("@", "%40");
